...
public abstract class HDTManager {
	...
	/**
	 * Create a new HDT by removing from a hdt the triples of with the same index of the bits of the deleteBitmap.
	 * @param location New HDT location
	 * @param hdtFileName HDT
	 * @param deleteBitmap The delete bitmap
	 * @param hdtFormat Parameters to tune the generated HDT
	 * @param listener Listener to get notified of loading progress. Can be null if no notifications needed.
	 * @return HDT
	 * @throws IOException when the file cannot be found
