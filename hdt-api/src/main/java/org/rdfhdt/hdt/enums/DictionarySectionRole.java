...
public enum DictionarySectionRole {
	SUBJECT(() -> TripleComponentRole.SUBJECT),
	PREDICATE(() -> TripleComponentRole.PREDICATE),
	OBJECT(() -> TripleComponentRole.OBJECT),
	SHARED(() -> TripleComponentRole.SUBJECT);
	...
	/**
	 * @return triple component role, if the dictionary role is shared, then the role is subject
	 */
