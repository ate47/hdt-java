...
public class WriteBitmapTriples implements TriplesPrivate {
	...
	public WriteBitmapTriples(HDTOptions spec, CloseSuppressPath triples) throws IOException {
		...
		bitY = new AppendableWriteBitmap(triples.resolve("bitmapY"));
		bitZ = new AppendableWriteBitmap(triples.resolve("bitmapZ"));
