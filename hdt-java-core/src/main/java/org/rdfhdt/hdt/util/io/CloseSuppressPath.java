...
public class CloseSuppressPath implements Path, Closeable {
	...
	public InputStream openInputStream(boolean buffered) throws IOException {
		InputStream stream = Files.newInputStream(wrapper);
	...
	public OutputStream openOutputStream(boolean buffered) throws IOException {
		OutputStream stream = Files.newOutputStream(wrapper);
