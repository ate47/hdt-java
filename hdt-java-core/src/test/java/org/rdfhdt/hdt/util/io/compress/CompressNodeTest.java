	...
	public void writeReadUtilTest() throws InterruptedException, IOException {
		...
		new ExceptionThread(() -> {
			...
			try {
				...
				new ExceptionThread(() -> {
					try {
						CompressUtil.writeCompressedSection(nodes, out);
						out.write(34);
						out.write(12);
						out.write(27);
					} finally {
	...
	public void writeReadMergeTest() throws InterruptedException, IOException {
		...
		new ExceptionThread(() -> {
			...
			try {
				...
				new ExceptionThread(() -> {
					try {
						CompressUtil.writeCompressedSection(nodes1, node1Out);
						node1Out.write(34);
						node1Out.write(12);
						node1Out.write(27);
					} finally {
				...
				new ExceptionThread(() -> {
					try {
						CompressUtil.writeCompressedSection(nodes2, node2Out);
						node2Out.write(42);
						node2Out.write(19);
						node2Out.write(1);
					} finally {
				...
				new ExceptionThread(() -> {
					try {
						CompressUtil.mergeCompressedSection(node1In, node2In, finalOut);
						finalOut.write(98);
						finalOut.write(18);
						finalOut.write(22);
