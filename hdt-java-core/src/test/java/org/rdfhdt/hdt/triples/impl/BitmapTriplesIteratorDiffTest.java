...
public class BitmapTriplesIteratorDiffTest {
    ...
    /**
     * print a HDT in the stdout
     * @param hdt HDT
     */
    public static void printHDT(HDT hdt) {
        TripleStringUtility triple = new TripleStringUtility(hdt);
        for (IteratorTripleID it = hdt.getTriples().searchAll(); it.hasNext();) {
    ...
    public void diffTest() throws IOException {
        ...
        ModifiableBitmap bitmap = BitmapFactory.createMemoryRWModifiableBitmap(data.tupleCountA);
